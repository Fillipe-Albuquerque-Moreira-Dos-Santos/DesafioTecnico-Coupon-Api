...
public class CupomService {
    ...
    public Cupom buscarPorId(Long id) {
        return repository.findByIdAndDeletedFalse(id).orElseThrow(() -> new RuntimeException("Cupom não encontrado"));
    }

    public void deletar(Long id) {
        Cupom cupom = repository.findById(id).orElseThrow(() -> new RuntimeException("Cupom não encontrado"));
